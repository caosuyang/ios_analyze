...
**********************************************************************/
Method class_getInstanceMethod(Class cls, SEL sel) // class_getInstanceMethod
{
...
#warning fixme build and search caches
    ...
    lookUpImpOrForward(nil, sel, cls, LOOKUP_RESOLVER); // lookUpImpOrForward
...
static void resolveClassMethod(id inst, SEL sel, Class cls)
{
    ...
    if (!lookUpImpOrNilTryCache(inst, @selector(resolveClassMethod:), cls)) {// lookUpImpOrNil
    ...
    BOOL (*msg)(Class, SEL, SEL) = (typeof(msg))objc_msgSend; // objc_msgSend
